...
* `line X-Y tangent to circle center O at T`: same geometry, but render the supporting tangent as a **carrier** (solid) line extended through the endpoints. If there’s no radius elsewhere, draw `O–T` thin to support the square.
